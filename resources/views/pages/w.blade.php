            ...
            <div class="root ">
                    ...
                    <div class="sharePanel">
                     ...
                     <div role="button" tabindex="0" class="SocialMediaShareButton SocialMediaShareButton--mail">
                            ...
                            <div class="sharePanel__social__share">
                                ...
                                <input type="text" value="" readonly="" id="previewlinkurlshare">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper-panel  top left search hidden expand">
                    ...
                    <div class="searchPanel">
                        <div class="searchPanel__input"><input type="text" class="dubai360-input search-input" placeholder="Search"></div>
                        <div class="searchPanel__filtered ">
                            <span class="searchPanel__filtered__title">Filter by</span>
                            <span class="icon-ic_arrow_up chevron-mobile"></span>
                            <span class="searchPanel__filtered__clear">reset</span>
                        </div>
                        <div class="searchPanel__wrapper-category">
                            <div class="category-wrapper ">
                                <span class="icon-ic_arrow_left_active_v2 icon-ic_arrow_left_active_v2_first category-wrapper--arrow is-activated--element"></span>
                                ...
                                <span class="icon-ic_arrow_right__active_v2 icon-ic_arrow_right__active_v2_first category-wrapper--arrow is-activated--element"></span>
                            </div>
                        </div>
                                    ...
                                    <div aria-label="grid" aria-readonly="true" class="ReactVirtualized__Grid" role="grid" tabindex="0" style="box-sizing: border-box; direction: ltr; position: relative; width: 600px; will-change: transform; overflow: hidden auto;">
                                        <div id="searchContainer" class="ReactVirtualized__Grid__innerScrollContainer" role="rowgroup" style="position: relative; display: -webkit-flex; display: -moz-flex; display: -ms-flex; display: -o-flex; display: flex; -webkit-flex-wrap: wrap; -moz-flex-wrap: wrap; -ms-flex-wrap: wrap; -o-flex-wrap: wrap; flex-wrap: wrap;">
                                            <!-- <div class="listItem-wrapper">
                                                <div class="listItem">
                                                    <div class="listItem__img"><img src="https://d360-cdn-prod.azureedge.net/4cd9086a-91d0-417a-a5f4-94762b94d1a9/input.tiles/thumb_200_100.jpg" class="listItem__img--scene"></div>
                                                    <div class="listItem__icon-category">
                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(66, 213, 175);"><img src="https://d360-cdn-prod.azureedge.net/assets/a660166c-2124-4384-9db7-263868b2054d.svg"></div>
                                                    </div>
                                                    <div class="listItem__text">
                                                        <div><span><span><span>01 Skydive Dubai</span><br><span>Palm, Entrance</span><br><span>Outside</span></span><span style="position: fixed; visibility: hidden; top: 0px; left: 0px;">…</span></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="listItem-wrapper">
                                                <div class="listItem">
                                                    <div class="listItem__img"><img src="https://d360-cdn-prod.azureedge.net/e56f5dbb-8df6-4a6b-9016-8c6737759756/input.tiles/thumb_200_100.jpg" class="listItem__img--scene"></div>
                                                    <div class="listItem__icon-category">
                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(66, 213, 175);"><img src="https://d360-cdn-prod.azureedge.net/assets/a660166c-2124-4384-9db7-263868b2054d.svg"></div>
                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(0, 71, 186);"><img src="https://d360-cdn-prod.azureedge.net/assets/a9ddd1e8-b753-437d-ae15-cc8895c06985.svg"></div>
                                                    </div>
                                                    <div class="listItem__text">
                                                        <div><span><span><span>35 Emirates Golf Club</span><br><span>Faldo Course Hole 11</span><br><span>Green</span></span><span style="position: fixed; visibility: hidden; top: 0px; left: 0px;">…</span></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="listItem-wrapper">
                                                <div class="listItem">
                                                    <div class="listItem__img"><img src="https://d360-cdn-prod.azureedge.net/2411ecee-c1dd-4080-a66f-c9748d7305d6/input.tiles/thumb.jpg" class="listItem__img--scene"></div>
                                                    <div class="listItem__icon-category">
                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(66, 213, 175);"><img src="https://d360-cdn-prod.azureedge.net/assets/a660166c-2124-4384-9db7-263868b2054d.svg"></div>
                                                    </div>
                                                    <div class="listItem__text">
                                                        <div><span><span><span>Al Badia Golf Club,</span><br><span>Hole 01 Fairway</span></span><span style="position: fixed; visibility: hidden; top: 0px; left: 0px;">…</span></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="listItem-wrapper">
                                                ...
                                                <div style="overflow: visible;">
                                                    <div aria-label="grid" aria-readonly="true" class="ReactVirtualized__Grid" role="grid" tabindex="0" style="box-sizing: border-box; direction: ltr; height: 507px; position: relative; width: 372px; will-change: transform; overflow: auto;">
                                                        <div id="searchContainerMobile" class="ReactVirtualized__Grid__innerScrollContainer" role="rowgroup">
                                                            <!-- <div class="listItem-wrapper" style="height: 208px; left: 0px; position: absolute; top: 0px; width: 186px;">
                                                                <div class="listItem" style="width: 170px; height: 192px;">
                                                                    <div class="listItem__img"><img src="https://d360-cdn-prod.azureedge.net/40d85105-469b-46f3-a91e-9e67b5fe88ba/input.tiles/thumb.jpg" class="listItem__img--scene"></div>
                                                                    <div class="listItem__icon-category">
                                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(2, 180, 227);"><img src="https://d360-cdn-prod.azureedge.net/assets/855eeadb-8821-495a-9ad9-78e5975addb4.svg"></div>
                                                                    </div>
                                                                    <div class="listItem__text">
                                                                        <div><span><span><span>Al Qasr Hotel, Lobby</span><br><span>01</span></span><span style="position: fixed; visibility: hidden; top: 0px; left: 0px;">…</span></span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="listItem-wrapper" style="height: 208px; left: 186px; position: absolute; top: 0px; width: 186px;">
                                                                <div class="listItem" style="width: 170px; height: 192px;">
                                                                    <div class="listItem__img"><img src="https://d360-cdn-prod.azureedge.net/b295e3da-4545-40da-9d73-083b8ae41790/input.tiles/thumb.jpg" class="listItem__img--scene"></div>
                                                                    <div class="listItem__icon-category">
                                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(2, 180, 227);"><img src="https://d360-cdn-prod.azureedge.net/assets/855eeadb-8821-495a-9ad9-78e5975addb4.svg"></div>
                                                                    </div>
                                                                    <div class="listItem__text">
                                                                        <div><span><span><span>Al Qasr Hotel, Lobby</span><br><span>2</span></span><span style="position: fixed; visibility: hidden; top: 0px; left: 0px;">…</span></span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="listItem-wrapper" style="height: 208px; left: 0px; position: absolute; top: 208px; width: 186px;">
                                                                <div class="listItem" style="width: 170px; height: 192px;">
                                                                    <div class="listItem__img"><img src="https://d360-cdn-prod.azureedge.net/51dcd20b-6ac5-4b74-a296-74f073e9827b/input.tiles/thumb.jpg" class="listItem__img--scene"></div>
                                                                    <div class="listItem__icon-category">
                                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(2, 180, 227);"><img src="https://d360-cdn-prod.azureedge.net/assets/855eeadb-8821-495a-9ad9-78e5975addb4.svg"></div>
                                                                    </div>
                                                                    <div class="listItem__text">
                                                                        <div><span><span><span>Al Qasr Hotel, Lobby</span><br><span>3</span></span><span style="position: fixed; visibility: hidden; top: 0px; left: 0px;">…</span></span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="listItem-wrapper" style="height: 208px; left: 186px; position: absolute; top: 208px; width: 186px;">
                                                                <div class="listItem" style="width: 170px; height: 192px;">
                                                                    <div class="listItem__img"><img src="https://d360-cdn-prod.azureedge.net/04a17bed-528d-48a7-bc09-dd32f44894a6/input.tiles/thumb.jpg" class="listItem__img--scene"></div>
                                                                    <div class="listItem__icon-category">
                                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(2, 180, 227);"><img src="https://d360-cdn-prod.azureedge.net/assets/855eeadb-8821-495a-9ad9-78e5975addb4.svg"></div>
                                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(241, 107, 36);"><img src="https://d360-cdn-prod.azureedge.net/assets/9e042238-2ddf-4529-aa63-96c7ace4409f.svg"></div>
                                                                    </div>
                                                                    <div class="listItem__text">
                                                                        <div><span><span><span>Al Qasr Hotel,</span><br><span>Pierchic Restaurant</span></span><span style="position: fixed; visibility: hidden; top: 0px; left: 0px;">…</span></span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="listItem-wrapper" style="height: 208px; left: 0px; position: absolute; top: 416px; width: 186px;">
                                                                <div class="listItem" style="width: 170px; height: 192px;">
                                                                    <div class="listItem__img"><img src="https://d360-cdn-prod.azureedge.net/12fcb75d-9294-4b08-b68c-a0c5b1f9ab3e/input.tiles/thumb.jpg" class="listItem__img--scene"></div>
                                                                    <div class="listItem__icon-category">
                                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(2, 180, 227);"><img src="https://d360-cdn-prod.azureedge.net/assets/855eeadb-8821-495a-9ad9-78e5975addb4.svg"></div>
                                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(0, 173, 159);"><img src="https://d360-cdn-prod.azureedge.net/assets/447aa566-4e20-4a69-80b1-80dddd5fba9a.svg"></div>
                                                                    </div>
                                                                    <div class="listItem__text">
                                                                        <div><span><span><span>Al Qasr Hotel, Royal</span><br><span>Suite, Bathroom</span></span><span style="position: fixed; visibility: hidden; top: 0px; left: 0px;">…</span></span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="listItem-wrapper" style="height: 208px; left: 186px; position: absolute; top: 416px; width: 186px;">
                                                                <div class="listItem" style="width: 170px; height: 192px;">
                                                                    <div class="listItem__img"><img src="https://d360-cdn-prod.azureedge.net/189b8f13-9ef0-4861-b561-bc781001a689/input.tiles/thumb.jpg" class="listItem__img--scene"></div>
                                                                    <div class="listItem__icon-category">
                                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(2, 180, 227);"><img src="https://d360-cdn-prod.azureedge.net/assets/855eeadb-8821-495a-9ad9-78e5975addb4.svg"></div>
                                                                        <div class="icon-wrapper__icon--category category-normal" style="background-color: rgb(0, 173, 159);"><img src="https://d360-cdn-prod.azureedge.net/assets/447aa566-4e20-4a69-80b1-80dddd5fba9a.svg"></div>
                                                                    </div>
                                                                    <div class="listItem__text">
                                                                        <div><span><span><span>Al Qasr Hotel, Royal</span><br><span>Suite, Bedroom</span></span><span style="position: fixed; visibility: hidden; top: 0px; left: 0px;">…</span></span></div>
                                                                    </div>
                                                                </div>
                                                            </div> -->
                                                        </div>
                    ...
                    <div class="infoPanel">
                        <div class="infoPanel__current-categories">
                         ...
                         <div class="clock">
                            ...
                            <span id="vremyaraboti">с 10-00 до 19-00</span>
                        </div>
                         <div class="numberr">
                       ...
                       <!--  <div class="infoPanel__title">{{ $location->name }}</div> -->
                        ...
                        <ul class="sharePanel__social__icons" style="    width: 200px;">
                            @isset($location->facebook)
                                <li class="socialnetwork-icon" id="sharefacebook">
                                    <a href="{{$location->facebook}}" target="_blank" id="sharefacebookurl">
                                        <div style="width: 40px; height: 40px;">
                                            <img src="/storage/socialnetworks/facebook.png" alt="facebook share" />
                                        </div>
                                    </a>
                                ...
                                @isset($location->telegram)
                                 <li class="socialnetwork-icon"  id="sharetelegram">
                                    <a href="{{$location->telegram}}" target="_blank" id="sharetelegramurl">
                                        <div style="width: 40px; height: 40px;">
                                           <img src="/storage/socialnetworks/telegram.png" alt="telegram share" />
                                        </div>
                                    </a>
                               ...
                               @isset($location->instagram)
                                <li class="socialnetwork-icon"  id="shareinstagram">
                                      <a href="{{$location->instagram}}" target="_blank" id="shareinstagramurl">
                                        <div style="width: 40px; height: 40px;">
            ...
            <div class="kak2 sad" style="opacity: 1;">
              <div class="wrapper-panel explorePannel top left hidden fullScreenPanel">
                <div class="SplitPane  horizontal " style="display: flex; flex: 1 1 0%; height: 100%; position: absolute; outline: none; overflow: hidden; user-select: text; bottom: 0px; flex-direction: column; min-height: 100%; top: 0px; width: 100%;">
                  <div class="Pane horizontal Pane1  " style="flex: 0 0 auto; position: relative; outline: none; height: 50%; display: flex;">
                    <div style="overflow: visible; height: 100%; width: 100%;">
                      <div style="width: 100%; height: 100%;">
                        <div id="map"></div>
                          <!-- <div id="map-krpano" class="krpano">
                            <div id="krpanoSWFObject3" tabindex="-1" style="position: relative; overflow: hidden; line-height: normal; font-weight: normal; font-style: normal; outline: 0px; background: rgb(255, 255, 255); width: 100%; height: 100%;">
                              <div style="position: absolute; left: 0px; top: 0px; width: 1366px; height: 333px; overflow: hidden; user-select: none; touch-action: none; -webkit-tap-highlight-color: transparent; cursor: default;">
                                <div style="position: absolute; left: 0px; top: 0px; width: 100%; height: 100%; overflow: hidden; pointer-events: none;">
                                  <canvas width="1366" height="333" style="position: absolute; left: 0px; top: 0px; width: 1366px; height: 333px;"></canvas>
                                </div>
                                <div style="position: absolute; left: 0px; top: 0px; width: 100%; height: 100%; overflow: hidden; user-select: none; transform-style: preserve-3d;">
                                  <div style="display: none; position: absolute; z-index: 2001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://d360-cdn-prod.azureedge.net/assets/bf94159a-0df2-4746-a72a-872a1ecbaa5aTear.png&quot;);">
                                    <div style="position: absolute; z-index: 3001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://www.dubai360.com/content/images/ic_play.png&quot;); width: 25px; height: 25px; background-position: 0px 0px; background-size: 25px 25px; transform: translateZ(1e+12px) translate(-25px, -25px) translate(12.5px, 12.5px) rotate(0deg) translate(-12.5px, -12.5px);"></div>
                                  </div>
                                  <div style="position: absolute; z-index: 2001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://d360-cdn-prod.azureedge.net/assets/bf94159a-0df2-4746-a72a-872a1ecbaa5aTear.png&quot;); width: 39.6px; height: 50.82px; background-position: 0px 0px; background-size: 39.6px 50.82px; transform-origin: 50% 50%; transform: translateZ(0px) translate(3254.95px, -3055.7px) translate(-19.8px, -25.41px) rotate(0deg) translate(0px, 0px) scale(1, 1) translate(0px, -25.41px);">
                                    <div style="position: absolute; z-index: 3001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://www.dubai360.com/content/images/ic_play.png&quot;); width: 25px; height: 25px; background-position: 0px 0px; background-size: 25px 25px; transform: translateZ(1e+12px) translate(15px, 26px) translate(12.5px, 12.5px) rotate(0deg) translate(-12.5px, -12.5px);"></div>
                                  </div>
                                  <div style="position: absolute; z-index: 2001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://d360-cdn-prod.azureedge.net/assets/bf94159a-0df2-4746-a72a-872a1ecbaa5aTear.png&quot;); width: 39.6px; height: 50.82px; background-position: 0px 0px; background-size: 39.6px 50.82px; transform-origin: 50% 50%; transform: translateZ(0px) translate(6623.4px, -5501.22px) translate(-19.8px, -25.41px) rotate(0deg) translate(0px, 0px) scale(1, 1) translate(0px, -25.41px);">
                                    <div style="position: absolute; z-index: 3001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://www.dubai360.com/content/images/ic_play.png&quot;); width: 25px; height: 25px; background-position: 0px 0px; background-size: 25px 25px; transform: translateZ(1e+12px) translate(15px, 26px) translate(12.5px, 12.5px) rotate(0deg) translate(-12.5px, -12.5px);"></div>
                                  </div>
                                  <div style="position: absolute; z-index: 2001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://d360-cdn-prod.azureedge.net/assets/a660166c-2124-4384-9db7-263868b2054dTear.png&quot;); width: 39.6px; height: 50.82px; background-position: 0px 0px; background-size: 39.6px 50.82px; transform-origin: 50% 50%; transform: translateZ(0px) translate(8494.64px, 7805.56px) translate(-19.8px, -25.41px) rotate(0deg) translate(0px, 0px) scale(1, 1) translate(0px, -25.41px); display: none;">
                                    <div style="position: absolute; z-index: 3001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://www.dubai360.com/content/images/ic_play.png&quot;); width: 25px; height: 25px; background-position: 0px 0px; background-size: 25px 25px; transform: translateZ(1e+12px) translate(15px, 26px) translate(12.5px, 12.5px) rotate(0deg) translate(-12.5px, -12.5px);"></div>
                                  </div>
                                  <div style="position: absolute; z-index: 2001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://d360-cdn-prod.azureedge.net/assets/f2e8db22-b04a-4a36-9541-bfce68047d8bTear.png&quot;); width: 39.6px; height: 50.82px; background-position: 0px 0px; background-size: 39.6px 50.82px; transform-origin: 50% 50%; transform: translateZ(0px) translate(7915.5px, -5687.26px) translate(-19.8px, -25.41px) rotate(0deg) translate(0px, 0px) scale(1, 1) translate(0px, -25.41px);">
                                    <div style="position: absolute; z-index: 3001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://www.dubai360.com/content/images/ic_play.png&quot;); width: 25px; height: 25px; background-position: 0px 0px; background-size: 25px 25px; transform: translateZ(1e+12px) translate(15px, 26px) translate(12.5px, 12.5px) rotate(0deg) translate(-12.5px, -12.5px);"></div>
                                  </div>
                                  <div style="position: absolute; z-index: 2001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://d360-cdn-prod.azureedge.net/assets/f2e8db22-b04a-4a36-9541-bfce68047d8bTear.png&quot;); width: 39.6px; height: 50.82px; background-position: 0px 0px; background-size: 39.6px 50.82px; transform-origin: 50% 50%; transform: translateZ(0px) translate(8498.11px, -3960.02px) translate(-19.8px, -25.41px) rotate(0deg) translate(0px, 0px) scale(1, 1) translate(0px, -25.41px); display: none;">
                                    <div style="position: absolute; z-index: 3001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://www.dubai360.com/content/images/ic_play.png&quot;); width: 25px; height: 25px; background-position: 0px 0px; background-size: 25px 25px; transform: translateZ(1e+12px) translate(15px, 26px) translate(12.5px, 12.5px) rotate(0deg) translate(-12.5px, -12.5px);"></div>
                                  </div>
                                  <div style="position: absolute; z-index: 2001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://d360-cdn-prod.azureedge.net/assets/f2e8db22-b04a-4a36-9541-bfce68047d8bTear.png&quot;); width: 39.6px; height: 50.82px; background-position: 0px 0px; background-size: 39.6px 50.82px; transform-origin: 50% 50%; transform: translateZ(0px) translate(-1599.83px, 4707.08px) translate(-19.8px, -25.41px) rotate(0deg) translate(0px, 0px) scale(1, 1) translate(0px, -25.41px);">
                                    <div style="position: absolute; z-index: 3001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://www.dubai360.com/content/images/ic_play.png&quot;); width: 25px; height: 25px; background-position: 0px 0px; background-size: 25px 25px; transform: translateZ(1e+12px) translate(15px, 26px) translate(12.5px, 12.5px) rotate(0deg) translate(-12.5px, -12.5px);"></div>
                                  </div>
                                  <div style="position: absolute; z-index: 2001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://d360-cdn-prod.azureedge.net/assets/f2e8db22-b04a-4a36-9541-bfce68047d8bTear.png&quot;); width: 39.6px; height: 50.82px; background-position: 0px 0px; background-size: 39.6px 50.82px; transform-origin: 50% 50%; transform: translateZ(0px) translate(8617.22px, -3259.12px) translate(-19.8px, -25.41px) rotate(0deg) translate(0px, 0px) scale(1, 1) translate(0px, -25.41px); display: none;">
                                    <div style="position: absolute; z-index: 3001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://www.dubai360.com/content/images/ic_play.png&quot;); width: 25px; height: 25px; background-position: 0px 0px; background-size: 25px 25px; transform: translateZ(1e+12px) translate(15px, 26px) translate(12.5px, 12.5px) rotate(0deg) translate(-12.5px, -12.5px);"></div>
                                  </div>
                                  <div style="position: absolute; z-index: 2001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://d360-cdn-prod.azureedge.net/assets/bf94159a-0df2-4746-a72a-872a1ecbaa5aTear.png&quot;); width: 39.6px; height: 50.82px; background-position: 0px 0px; background-size: 39.6px 50.82px; transform-origin: 50% 50%; transform: translateZ(0px) translate(-2987.4px, 2831.1px) translate(-19.8px, -25.41px) rotate(0deg) translate(0px, 0px) scale(1, 1) translate(0px, -25.41px);">
                                    <div style="position: absolute; z-index: 3001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://www.dubai360.com/content/images/ic_play.png&quot;); width: 25px; height: 25px; background-position: 0px 0px; background-size: 25px 25px; transform: translateZ(1e+12px) translate(15px, 26px) translate(12.5px, 12.5px) rotate(0deg) translate(-12.5px, -12.5px);"></div>
                                  </div>
                                  <div style="position: absolute; z-index: 2001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://d360-cdn-prod.azureedge.net/assets/330f2921-c1e9-4654-9c25-e6a439f313e4Tear.png&quot;); width: 39.6px; height: 50.82px; background-position: 0px 0px; background-size: 39.6px 50.82px; transform-origin: 50% 50%; transform: translateZ(0px) translate(6153.97px, -5097.73px) translate(-19.8px, -25.41px) rotate(0deg) translate(0px, 0px) scale(1, 1) translate(0px, -25.41px);">
                                    <div style="position: absolute; z-index: 3001; overflow: visible; opacity: 1; cursor: pointer; pointer-events: auto; background-image: url(&quot;https://www.dubai360.com/content/images/ic_play.png&quot;); width: 25px; height: 25px; background-position: 0px 0px; background-size: 25px 25px; transform: translateZ(1e+12px) translate(15px, 26px) translate(12.5px, 12.5px) rotate(0deg) translate(-12.5px, -12.5px);"></div>
                                  </div>
                                </div>
                              </div>
                              <div style="position: absolute; left: 0px; bottom: 0px; width: 100%; height: 156px; overflow: hidden; display: none; transform: translateZ(2e+12px); z-index: 999999999;">
                                <div style="position: absolute; left: 0px; top: 0px; width: 100%; height: 100%; overflow: hidden; opacity: 0.67; background-color: rgb(0, 0, 0); box-shadow: rgb(255, 255, 255) 0px 0px 8px; margin-top: 8px;"></div>
                                <pre style="font-family: &quot;Courier New&quot;; font-size: 11px; position: absolute; left: 5px; top: 0px; padding: 0px 16px 0px 0px; background: none; border: 0px; margin-top: 10px; width: 100%; height: 146px; overflow: auto; display: block; text-align: left; white-space: pre-line; text-size-adjust: none; color: rgb(255, 255, 255); cursor: text;">INFO: krpano 1.19-pr13 (build 2017-09-21) INFO: HTML5/Desktop - Chrome 72.0 - WebGL INFO: Registered to: PLAIN CONCEPTS S.L. <span style="color:#AACCFF;">WARNING: There is already a blocking lookto(), the current call will be skipped!</span> <span style="color:#AACCFF;">WARNING: There is already a blocking lookto(), the current call will be skipped!</span> <span style="color:#AACCFF;">WARNING: There is already a blocking lookto(), the current call will be skipped!</span> <span style="color:#AACCFF;">WARNING: There is already a blocking lookto(), the current call will be skipped!</span> <span style="color:#AACCFF;">WARNING: There is already a blocking lookto(), the current call will be skipped!</span> </pre>
                                <div style="position: absolute; right: 0px; top: 10px; padding: 0px 4px; height: 30px; user-select: none; cursor: pointer; -webkit-tap-highlight-color: transparent; font-family: &quot;Courier New&quot;; font-size: 10px; color: rgb(255, 255, 255);">CLOSE</div>
                                <div style="position: absolute; right: 0px; bottom: 0px; padding: 0px 4px 4px; height: 12px; user-select: none; cursor: pointer; -webkit-tap-highlight-color: transparent; font-family: &quot;Courier New&quot;; font-size: 10px; color: rgb(15, 255, 0); display: none;">LAYERS</div>
                                <div style="position: absolute; right: 0px; bottom: 18px; padding: 4px 4px 0px; height: 12px; user-select: none; cursor: pointer; -webkit-tap-highlight-color: transparent; font-family: &quot;Courier New&quot;; font-size: 10px; color: rgb(15, 255, 0); display: none;">HOTSPOTS</div>
                              </div>
                            </div>
                          </div> -->
                    ...
                    <span class="Resizer horizontal "></span>
                  ...
                  <div class="Pane horizontal Pane2  " style="height: 100%;position: relative; outline: none; overflow: auto;border-top: 1px solid rgba(0, 0, 0, 0.2);background-color: #f3f3f3;">
                    <div class="explore__listContainer">
                      <div class="virtualizedGrid__otherLocation__wrapper mytab mytab1" style="height: 278px;">
                        <div class="virtualizedGrid">
                          ...
                          <div class="virtualizedGrid__content " style="position: relative;">
                            <div class="virtualizedGrid__otherLocation__title"><span>Featured locations</span></div>
                      ...
                      <div class="virtualizedGrid__otherLocation__wrapper mytab mytab2" style="height: 278px;">
                        <div class="virtualizedGrid">
                          ...
                          <div class="virtualizedGrid__content " style="position: relative;">
                            <div class="virtualizedGrid__otherLocation__title"><span>Recently added</span></div>
...
{
    $("#sharefacebook").show();
    $("#sharefacebookurl").attr("href", data.facebook)
} else {$("#sharefacebook").hide();}
if (data.instagram != "")
{
    $("#shareinstagram").show();
    $("#shareinstagramurl").attr("href", data.instagram)
} else {$("#shareinstagram").hide();}
if (data.telegram != "")
{
    $("#sharetelegram").show();
    $("#sharetelegramurl").attr("href", data.facebook)
} else {$("#sharetelegram").hide();}
    })
