                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="btn-group" data-toggle="buttons">
                                        <label class="btn btn-lg btn-default active">
                                            <input type="radio" name="radio-editor-mode" id="radio-editor-mode-edit"
                                                   checked>Edit
                                        </label>
                                        <label style="display:none" class="btn btn-lg btn-default"
                                               id="radio-editor-mode-preview-label">
                                        ...
                                        <label class="btn btn-lg btn-default" id="radio-editor-mode-jquery-label"
                                               style="display:none">
                                            <input type="radio" name="radio-editor-mode" id="radio-editor-mode-jquery">jQuery
                                            Code
                                        </label>
                                    ...
                                    <div class="panel panel-default" id="panel-editor">
                                        <div class="panel-body" id="panel-canvas">
                                            <div class="ndd-drawable-canvas">
                                                <img src="/storage/floors/{{$floor->image}}"
                                                     class="ndd-drawable-canvas-image">
                                        ...
                                        <select class="form-control" name="input-title" id="input-location" disabled>
                                            ...
                                            @foreach($locations as $location)
                                                <option value="{{$location->id}}" data-slug="{{$location->slug}}"
                                                        data-icon="{{$location->locscats[0]->cat_icon}}">{{$location->name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group"><input type="submit" value="Update" id="etajupdatee"
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="btn-group" data-toggle="buttons">
                                                                    <label class="btn btn-default active">
                                                                        <input type="radio" name="radio-content-type"
                                                                               id="radio-content-type-text" checked>Text
                                                                    </label>

                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-content-type"
                                                                               id="radio-content-type-custom-html">Custom
                                                                        HTML
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="color-text-color"
                                                                   class="col-md-3 control-label">Text Color</label>
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <input type="color" class="form-control"
                                                                           id="color-text-color" value="#ffffff">
                                                                    <span class="input-group-addon"
                                                                          id="color-text-color-hex">#fff</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label">Deep Linking
                                                                URL</label>
                                                            <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="color-tint-color"
                                                                   class="col-md-3 control-label">Tint Color</label>
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <input type="color" class="form-control"
                                                                           id="color-tint-color" value="#000000">
                                                                    <span class="input-group-addon"
                                                                          id="color-tint-color-hex">#000</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="btn-group btn-group-no-margin"
                                                                    ...
                                                                    <label class="btn btn-default active">
                                                                        <input type="radio" name="radio-popup-position"
                                                                    ...
                                                                    <label class="btn btn-default">
                                                                        ...
                                                                        <div class="icon-in-label ndd-spot-icon icon-style-5">
                                                                            <img src="/flooreditor/img/annotator-pro/icon_loc_01.png">
                                                                        </div>
                                                                    </label>
                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-popup-position"
                                                                        ...
                                                                        <div class="icon-in-label ndd-spot-icon icon-style-6">
                                                                            <img src="/flooreditor/img/annotator-pro/icon_loc_02.png">
                                                                        </div>
                                                                    </label>
                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-popup-position"
                                                                        ...
                                                                        <div class="icon-in-label ndd-spot-icon icon-style-7">
                                                                            <img src="/flooreditor/img/annotator-pro/icon_loc_03.png">
                                                                        </div>
                                                                    </label>
                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-popup-position"
                                                                        ...
                                                                        <div class="icon-in-label ndd-spot-icon icon-style-8">
                                                                            <img src="/flooreditor/img/annotator-pro/icon_loc_04.png">
                                                                        </div>
                                                                    </label>
                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-popup-position"
                                                                        ...
                                                                        <div class="icon-in-label ndd-spot-icon icon-style-9">
                                                                            <img src="/flooreditor/img/annotator-pro/icon_loc_05.png">
                                                                        </div>
                                                                    </label>
                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-popup-position"
                                                                        ...
                                                                        <div class="icon-in-label ndd-spot-icon icon-style-10">
                                                                            <img src="/flooreditor/img/annotator-pro/icon_loc_06.png">
                                                                        </div>
                                                                    </label>
                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-popup-position"
                                                                        ...
                                                                        <div class="icon-in-label ndd-spot-icon icon-style-11">
                                                                            <img src="/flooreditor/img/annotator-pro/icon_loc_07.png">
                                                                        </div>
                                                                    </label>
                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-popup-position"
                                                                        ...
                                                                        <div class="icon-in-label ndd-spot-icon icon-style-12">
                                                                            <img src="/flooreditor/img/annotator-pro/icon_loc_08.png">
                                                                        </div>
                                                                    </label>
                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-popup-position"
                                                                        ...
                                                                        <div class="icon-in-label ndd-spot-icon icon-style-13">
                                                                            <img src="/flooreditor/img/annotator-pro/icon_loc_09.png">
                                                                        </div>
                                                                    </label>
                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-popup-position"
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control"
                                                                           id="input-popup-width">
                                                                    <span class="input-group-addon"
                                                                          id="input-popup-width-addon">px</span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control"
                                                                           id="input-popup-height">
                                                                    <span class="input-group-addon"
                                                                          id="input-popup-height-addon">px</span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="radio-popup-position"
                                                                   class="col-md-3 control-label">Popup Position</label>
                                                            <div class="col-md-9">
                                                                <div class="btn-group" data-toggle="buttons">
                                                                    <label class="btn btn-default active">
                                                                        <input type="radio" name="radio-popup-position"
                                                                               id="radio-popup-position-top" checked>Top
                                                                    </label>
                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-popup-position"
                                                                               id="radio-popup-position-bottom">Bottom
                                                                    </label>
                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-popup-position"
                                                                               id="radio-popup-position-left">Left
                                                                    </label>
                                                                    <label class="btn btn-default">
                                                                        <input type="radio" name="radio-popup-position"
                                                                               id="radio-popup-position-right">Right
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="checkbox" id="checkbox-width-auto"
                                                                           checked>Auto
                                                                </label>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="btn-group" data-toggle="buttons">
                                                                <label class="btn btn-default active">
                                                                    <input type="radio" name="radio-max-zoom"
                                                                           id="radio-max-zoom-1-1" checked>1:1
                                                                </label>
                                                                <label class="btn btn-default">
                                                                    <input type="radio" name="radio-max-zoom"
                                                                           id="radio-max-zoom-1">1x
                                                                </label>
                                                                <label class="btn btn-default">
                                                                    <input type="radio" name="radio-max-zoom"
                                                                           id="radio-max-zoom-2">2x
                                                                </label>
                                                                <label class="btn btn-default">
                                                                    <input type="radio" name="radio-max-zoom"
                                                                           id="radio-max-zoom-3">3x
                                                                </label>
                                                                <label class="btn btn-default">
                                                                    <input type="radio" name="radio-max-zoom"
                                                                           id="radio-max-zoom-4">4x
                                                                </label>
                                                                <label class="btn btn-default">
                                                                    <input type="radio" name="radio-max-zoom"
                                                                           id="radio-max-zoom-custom">Custom
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="checkbox-navigator-image-preview"
                                                               class="col-md-3 control-label">Navigator Image
                                                            Preview</label>
                                                        <div class="col-md-9">
                                                            <div class="checkbox">
                                                                <label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="checkbox-fullscreen" class="col-md-3 control-label">Enable
                                                            Fullscreen</label>
                                                        <div class="col-md-9">
                                                            <div class="checkbox">
                                                                <label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="checkbox-rubberbanding"
                                                               class="col-md-3 control-label">Enable
                                                            Rubberbanding</label>
                                                        <div class="col-md-9">
                                                            <div class="checkbox">
                                                                <label>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-danger" data-dismiss="modal"
                                                    id="delete-annotation-button">Delete
                                            </button>
                                        </div>
                                    </div>
                                </div>
