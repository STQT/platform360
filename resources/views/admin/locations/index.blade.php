                                ...
                                @foreach($locations as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($item->panorama)
                                                <a href="{{ '/storage/panoramas/' . pathinfo(str_replace('.tiles', '', $item->xmlName(json_decode($item->panorama)[0]->panoramas[0]->panorama)))['filename'] . '.jpg' }}" title="Оригинал"><button class="btn btn-info btn-sm"><i class="fa fa-image" aria-hidden="true"></i></button></a>
                                            @endif
                                            @if($item->video)
