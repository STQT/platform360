...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
        ...
        <div class="form-group">
            <input {{ isset($location) ? ($location->onmap ? 'checked' : '') : ''}} id="onmap" type="checkbox" class=""
                   name="onmap"> Показать на карте?
        </div>
        ...
        <div class="form-group">
            <input {{ isset($location) ? ($location->isfeatured ? 'checked' : '') : ''}} id="isfeatured" type="checkbox"
                   class="" name="isfeatured"> Избранный?
        </div>

        <div class="form-group">
            <input {{ $sky->show_sublocation == 1 ? 'checked' : ''}} id="show_sublocation" type="checkbox" class=""
                   name="show_sublocation" value="1"> Показывать в поиске
        </div>

        <div class="form-group">
            <input {{ isset($sky) ? ($sky->published ? 'checked' : '') : ''}} id="published" type="checkbox" class=""
                   value="1" name="published"> Опубликовано
        </div>
        ...
        <div class="form-group">
            <input {{ isset($location) ? ($location->isDefault ? 'checked' : '') : ''}} id="isDefault" type="checkbox"
                   class="" name="isDefault"> Основной
        </div>
